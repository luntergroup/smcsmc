...
#
# experiment:
#  uni directional migration gap OLD model with strong migr, delay based on recombheight, few epochs
#  testing the convergence of the naive and FSDR samplers
#  the newer unidirmigrgap model analysis failed to infer the period of migration. See if this does better
#
###################################################################################
...
experiment_name = "unidirmigrgapOLD_convergence"
...
def run_experiment( length, simseed, infseed, numparticles, lag, nsam, biasheights, biasstrengths, delay ):
    ...
    e.pop.change_points = [0,0.058,0.116,0.4]
