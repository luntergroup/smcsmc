...
#
# experiment:
#  Same as _byparticles2, but now without biasing pilots
#
###################################################################################
...
experiment_name = "constpopsize_3epochs_particles3"
...
def run_experiment( length, simseed, infseed, numparticles, lag ):
    ...
    e.bias_heights = None         # the only difference with _byparticles2
    e.bias_strengths = None
