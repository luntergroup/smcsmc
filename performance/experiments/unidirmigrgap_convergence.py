...
#
# experiment:
#  uni directional migration gap, delay based on recombheight, few epochs
...
experiment_name = "unidirmigrgap_convergence"


# class defining default population parameters
import test_two_pops
experiment_class = test_two_pops.TestTwoPopsSplitUniDirMigrGap
