...
#
# experiment:
#  uni directional migration with gap, try inferring with many focusing choices,
#    20 epochs
#
###################################################################################
...
experiment_name = "unidirmigrgap_20epochs"
...
def run_experiment( length, simseed, infseed, numparticles, lag, nsam, biasheights, biasstrengths, delay ):
    ...
    e.smcsmc_initial_migr_rates = [ [[0,.2],[.2,0]],
                                    ...
                                    [[0,0] ,[0,0] ],
                                    [[0,0] ,[0,0] ] ]
    e.smcsmc_migration_commands = [ "-eM 0.00 0.2",
                                    "-eM 0.02 0.2",
                                    "-eM 0.04 0.2",
                                    "-eM 0.06 0.2",
                                    "-eM 0.08 0.2",
