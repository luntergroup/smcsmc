...
#  try inferring with many focusing choices without any application delay,
#  hopefully to see FSDR > FS
#
#
###################################################################################
...
focus_heights = [[2240]]
#focus_strengths = [[2,.9999],[3,.9999]]  # [2,1] and [2,0.9999] should not be any different when delay=0
focus_strengths = [[3,.9999]]
delays = [0]

# name of this experiment
experiment_name = "am3_focusing_nodelay"
