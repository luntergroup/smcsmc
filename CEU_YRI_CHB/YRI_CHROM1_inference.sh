...
#$ -e YRI_CHROM1_2sam_10000npErrFiles
#$ -o YRI_CHROM1_2sam_10000npOutFiles
#$ -N YRI_CHROM1_2sam_10000np
#$ -t 1-15
#$ -j y
...
pf-ARG ${cmd} -filter 100 -missing 1000000 -o ${outprefix}  -vcf YRI_2sample_CHROM1.vcf -log 
