...
rm src/scrm/src/summary_statistics/*.gcda
rm src/scrm/src/summary_statistics/*.gcno
rm src/scrm/src/random/*.gcda
rm src/scrm/src/random/*.gcno
rm src/scrm/src/*.gcda
rm src/scrm/src/*.gcno
