...
latex_documents = [
    (master_doc, 'SMCSMC.tex', u'SMCSMC Documentation',
     u'Christopher B Cole, Donna Henderson, Sha (Joe) Zhu, Gerton Lunter', 'manual'),
]
...
man_pages = [
    (master_doc, 'smcsmc', u'SMCSMC Documentation',
     [author], 1)
]
