...
void Help_option(){
    ...
    cout << setw(10)<<"-xr"     << setw(5) << "INT" << "  --  " << "Epoch or epoch range to exclude from recombination EM (0-based)" << endl;
    cout << setw(10)<<"-xc"     << setw(5) << "INT" << "  --  " << "Epoch (range) to exclude from coalescent/migration EM (0-based)" << endl;
