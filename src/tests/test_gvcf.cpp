...
class TestGVCF : public CppUnit::TestCase {
 ...
 public:
    ...
    void test_empty_file(){
        ...
        CPPUNIT_ASSERT_EQUAL( size_t(-1), gvcf_file->vcf_length_ );  // As this is an empty file, it will reach the end of the file, and seekg will go to "infinity", which is size_t(-1)
    ...
    void test_Constructors() {
        gvcf_file = new VariantReader("tests/test2sample.vcf", GVCF);
        CPPUNIT_ASSERT_EQUAL(string("tests/test2sample.vcf"), gvcf_file->file_name_);
        CPPUNIT_ASSERT_EQUAL(size_t(3227), gvcf_file->vcf_length_);  // wc test2sample.vcf, length of the file is 3227 characters

        CPPUNIT_ASSERT_EQUAL(size_t(1), gvcf_file->nsam());
        ...
        CPPUNIT_ASSERT_EQUAL(size_t(6518), gvcf_file->vcf_length_);  // wc test2sample.vcf, length of the file is 6518 characters
        ...
        CPPUNIT_ASSERT_EQUAL(size_t(13813), gvcf_file->vcf_length_);  // wc test2sample.vcf, length of the file is 13813 characters
